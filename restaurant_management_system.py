...
label_info = Label(top, font = ('arial',50,'bold'), text ="Ashok Vatika Restaurant", fg = "steel blue", bd = 6, anchor = 'w')
label_info.grid(row = 0, column = 0)

local_time = time.asctime(time.localtime(time.time()))

label_info = Label(top, font = ('arial',20,'bold'), text = local_time, fg = "steel blue", bd = 6, anchor = 'w')
